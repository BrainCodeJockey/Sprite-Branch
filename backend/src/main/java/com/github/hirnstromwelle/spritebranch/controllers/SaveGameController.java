...
public class SaveGameController {
    ...
    @PutMapping("/{saveId}")
    public SaveGameDto updateSaveGame(@PathVariable String saveId, @Valid @RequestBody SaveGameDto saveGameDto) {
        ...
        return modelMapper.map(saveGame, SaveGameDto.class);
    }
